...
[![CI](https://github.com/JuanchoData/Production-ML-MLOps-Pipeline/actions/workflows/ci.yml/badge.svg)](https://github.com/JuanchoData/Production-ML-MLOps-Pipeline/actions/workflows/ci.yml)
...
| PASS observations | 1,463 (93.36%) |
| FAIL observations | 104 (6.64%) |
| Missing cells | 41,951 |
| Sensors with at least one missing value | 538 |
| Sensors with >50% missing values in the full dataset | 28 |
| Constant features in the full dataset | 116 |
...
2. Fill remaining missing values using the training-set median.
3. Remove zero-variance features.
4. Standardize features when required by the model.
...
|---|---:|---:|
| Accuracy | 0.8408 | **0.8981** |
| FAIL Precision | 0.1081 | **0.2609** |
| FAIL Recall | 0.1905 | **0.2857** |
| FAIL F1 | 0.1379 | **0.2727** |
| ROC-AUC | 0.6203 | **0.7851** |
| PR-AUC | 0.1271 | **0.2020** |
...
|---|---|---|
| `/` | GET | API status |
| `/health` | GET | Verify model loading and threshold |
| `/predict` | POST | Generate PASS/FAIL prediction |
